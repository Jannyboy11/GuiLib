...
Easily create inventory GUIs! Have a look at the [JavaDocs](https://jitpack.io/com/github/Jannyboy11/GuiLib/GuiLib-API/v1.11.4/javadoc/xyz.janboerman.guilib.api/module-summary.html)!
...
##### Gradle
    ...
    dependencies {
        compileOnly 'com.github.Jannyboy11.GuiLib:GuiLib-Plugin:v1.11.4'
    }

##### Sbt

    resolvers += "jitpack" at "https://jitpack.io"
    libraryDependencies += "com.github.Jannyboy11.GuiLib" % "GuiLib-Plugin" % "v1.11.4" % "provided"	
